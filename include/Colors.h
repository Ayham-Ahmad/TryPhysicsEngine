...
public:
    ...
    static void DarkGray(SDL_Renderer *r)
    {
        SDL_SetRenderDrawColor(r, 60, 60, 60, 255);
    }

    static void VeryDarkGray(SDL_Renderer *r)
    {
        SDL_SetRenderDrawColor(r, 30, 30, 30, 255);
    }

    static void MediumGray(SDL_Renderer *r)
    {
        SDL_SetRenderDrawColor(r, 100, 100, 100, 255);
    }

    static void MustardYellow(SDL_Renderer *r)
    {
